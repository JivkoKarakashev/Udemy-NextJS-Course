...
const NewPost = (): ReactElement => {
  const [{ stage, title, image, content }, formAction] = useActionState(createPost, formStateInit);
    ...
    <>
      ...
      <form action={formAction}>
        <p className="form-control">
          ...
          <input
            className={stage !== 'initial' && !title.valid ? 'error' : undefined}
            type="text"
            id="title"
            name="title" />
        </p>
        ...
        <p className="form-control">
          ...
          <textarea
            className={stage !== 'initial' && !content.valid ? 'error' : undefined}
            id="content"
            name="content"
            rows={5} />
        </p>
